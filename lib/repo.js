...
Repo.prototype.getFileStat = function getFileStat(entry, absolutePath, relativePath, cb) {
    ...
    exec('git log ' + target, { cwd: this.clonedir },
...
Repo.prototype.tree = function list(relativePath, cb) {
    var directories,
        files,
        absolutePath = path.join(this.clonedir, relativePath);
...
Repo.prototype.blob = function list(relativePath, cb) {
    var absolutePath = path.join(this.clonedir, relativePath);
